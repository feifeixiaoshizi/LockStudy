 ...
 * to trigger the completion action {@link #onCompletion(java.util.concurrent.CountedCompleter)},
 * not just one.
 ...
 * optionally override method {@link #onCompletion(java.util.concurrent.CountedCompleter)}
 ...
 * in this tree implements an {@link #onCompletion(java.util.concurrent.CountedCompleter)} method,
 ...
 * in method {@link #onCompletion(java.util.concurrent.CountedCompleter)}. As illustrated in the following
...
public abstract class CountedCompleter<T> extends ForkJoinTask<T> {
     ...
     */
    public boolean onExceptionalCompletion(Throwable ex, java.util.concurrent.CountedCompleter<?> caller) {
        return true;
    }
    ...
    public final java.util.concurrent.CountedCompleter<?> getRoot() {
        java.util.concurrent.CountedCompleter<?> a = this, p;
     ...
     * otherwise invokes {@link #onCompletion(java.util.concurrent.CountedCompleter)}
     * and then similarly tries to complete this task's completer,
     * if one exists, else marks this task as complete.
     */
    public final void tryComplete() {
        java.util.concurrent.CountedCompleter<?> a = this, s = a;
        for (int c;;) {
            if ((c = a.pending) == 0) {
                a.onCompletion(s);
     ...
     * #onCompletion(java.util.concurrent.CountedCompleter)} along the completion path:
     * If the pending count is nonzero, decrements the count;
     ...
     * {@link #onCompletion(java.util.concurrent.CountedCompleter)}, marks this task as
     * complete and further triggers {@link #tryComplete} on this
     * task's completer, if one exists.  The given rawResult is
     * used as an argument to {@link #setRawResult} before invoking
     * {@link #onCompletion(java.util.concurrent.CountedCompleter)} or marking this task
    ...
    public final void quietlyCompleteRoot() {
        for (java.util.concurrent.CountedCompleter<?> a = this, p;;) {
    ...
    static {
        try {
            PENDING = U.objectFieldOffset
                (java.util.concurrent.CountedCompleter.class.getDeclaredField("pending"));
