 ...
 * @author Doug Lea
 */
public class DoubleAccumulator extends java.util.concurrent.atomic.Striped64 implements Serializable {
    ...
    private static class SerializationProxy implements Serializable {
        ...
        private Object readResolve() {
            ...
            java.util.concurrent.atomic.DoubleAccumulator a = new java.util.concurrent.atomic.DoubleAccumulator(function, d);
