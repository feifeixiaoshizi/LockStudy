...
public class Phaser {
    ...
    private int doArrive(int adjust) {
        final java.util.concurrent.Phaser root = this.root;
        for (;;) {
    ...
    private int doRegister(int registrations) {
        ...
        final java.util.concurrent.Phaser parent = this.parent;
        int phase;
        for (;;) {
    ...
    public Phaser(java.util.concurrent.Phaser parent, int parties) {
        ...
        this.parent = parent;
        if (parent != null) {
            final java.util.concurrent.Phaser root = parent.root;
            this.root = root;
    ...
    static {
        try {
            STATE = U.objectFieldOffset
                (java.util.concurrent.Phaser.class.getDeclaredField("state"));
