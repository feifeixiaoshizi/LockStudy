...
public class PriorityBlockingQueue<E> extends AbstractQueue<E>
    ...
    public PriorityBlockingQueue(Collection<? extends E> c) {
        ...
        else if (c instanceof java.util.concurrent.PriorityBlockingQueue<?>) {
            java.util.concurrent.PriorityBlockingQueue<? extends E> pq =
                (java.util.concurrent.PriorityBlockingQueue<? extends E>) c;
            this.comparator = (Comparator<? super E>) pq.comparator();
            screen = false;
            if (pq.getClass() == java.util.concurrent.PriorityBlockingQueue.class) // exact match
                heapify = false;
        }
        Object[] a = c.toArray();
        int n = a.length;
    ...
    static final class PBQSpliterator<E> implements Spliterator<E> {
        ...
        PBQSpliterator(java.util.concurrent.PriorityBlockingQueue<E> queue, Object[] array,
                       int index, int fence) {
            this.queue = queue;
            this.array = array;
            this.index = index;
    ...
    static {
        try {
            ALLOCATIONSPINLOCK = U.objectFieldOffset
                (java.util.concurrent.PriorityBlockingQueue.class.getDeclaredField("allocationSpinLock"));
