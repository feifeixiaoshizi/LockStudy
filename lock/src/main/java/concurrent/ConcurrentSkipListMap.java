...
public class ConcurrentSkipListMap<K,V> extends AbstractMap<K,V>
    ...
    public java.util.concurrent.ConcurrentSkipListMap<K,V> clone() {
        try {
            ...
            java.util.concurrent.ConcurrentSkipListMap<K,V> clone =
                (java.util.concurrent.ConcurrentSkipListMap<K,V>) super.clone();
            clone.initialize();
    ...
    abstract class Iter<T> implements Iterator<T> {
        ...
        public void remove() {
            ...
            java.util.concurrent.ConcurrentSkipListMap.this.remove(l.key);
            lastReturned = null;
        }
    ...
    static final class KeySet<K,V>
        ...
        public Iterator<K> iterator() {
            return (m instanceof java.util.concurrent.ConcurrentSkipListMap)
                ? ((java.util.concurrent.ConcurrentSkipListMap<K,V>)m).new KeyIterator()
        ...
        public Spliterator<K> spliterator() {
            return (m instanceof java.util.concurrent.ConcurrentSkipListMap)
                ? ((java.util.concurrent.ConcurrentSkipListMap<K,V>)m).keySpliterator()
                : ((SubMap<K,V>)m).new SubMapKeyIterator();
        }
    }
    ...
    static final class Values<K,V> extends AbstractCollection<V> {
        ...
        public Iterator<V> iterator() {
            return (m instanceof java.util.concurrent.ConcurrentSkipListMap)
                ? ((java.util.concurrent.ConcurrentSkipListMap<K,V>)m).new ValueIterator()
        ...
        public Spliterator<V> spliterator() {
            return (m instanceof java.util.concurrent.ConcurrentSkipListMap)
                ? ((java.util.concurrent.ConcurrentSkipListMap<K,V>)m).valueSpliterator()
                : ((SubMap<K,V>)m).new SubMapValueIterator();
        }

        public boolean removeIf(Predicate<? super V> filter) {
            if (filter == null) throw new NullPointerException();
            if (m instanceof java.util.concurrent.ConcurrentSkipListMap)
                return ((java.util.concurrent.ConcurrentSkipListMap<K,V>)m).removeValueIf(filter);
            // else use iterator
    ...
    static final class EntrySet<K,V> extends AbstractSet<Entry<K,V>> {
        ...
        public Iterator<Entry<K,V>> iterator() {
            return (m instanceof java.util.concurrent.ConcurrentSkipListMap)
                ? ((java.util.concurrent.ConcurrentSkipListMap<K,V>)m).new EntryIterator()
                : ((SubMap<K,V>)m).new SubMapEntryIterator();
        }
        ...
        public Spliterator<Entry<K,V>> spliterator() {
            return (m instanceof java.util.concurrent.ConcurrentSkipListMap)
                ? ((java.util.concurrent.ConcurrentSkipListMap<K,V>)m).entrySpliterator()
                : ((SubMap<K,V>)m).new SubMapEntryIterator();
        }
        public boolean removeIf(Predicate<? super Entry<K,V>> filter) {
            if (filter == null) throw new NullPointerException();
            if (m instanceof java.util.concurrent.ConcurrentSkipListMap)
                return ((java.util.concurrent.ConcurrentSkipListMap<K,V>)m).removeEntryIf(filter);
            // else use iterator
            Iterator<Entry<K,V>> it =
                ((SubMap<K,V>)m).new SubMapEntryIterator();
            boolean removed = false;
    ...
    /**
     * Submaps returned by {@link java.util.concurrent.ConcurrentSkipListMap} submap operations
    ...
    static final class SubMap<K,V> extends AbstractMap<K,V>
         ...
         */
        boolean isBeforeEnd(java.util.concurrent.ConcurrentSkipListMap.Node<K,V> n,
         ...
         */
        java.util.concurrent.ConcurrentSkipListMap.Node<K,V> loNode(Comparator<? super K> cmp) {
            if (lo == null)
                return m.findFirst();
            else if (loInclusive)
         ...
         * most usages need to check bounds.
         */
        java.util.concurrent.ConcurrentSkipListMap.Node<K,V> hiNode(Comparator<? super K> cmp) {
            if (hi == null)
                return m.findLast();
            else if (hiInclusive)
        ...
        K lowestKey() {
            ...
            java.util.concurrent.ConcurrentSkipListMap.Node<K,V> n = loNode(cmp);
        ...
        K highestKey() {
            Comparator<? super K> cmp = m.comparator;
            java.util.concurrent.ConcurrentSkipListMap.Node<K,V> n = hiNode(cmp);
            if (n != null) {
                K last = n.key;
        ...
        public int size() {
            Comparator<? super K> cmp = m.comparator;
            long count = 0;
            for (java.util.concurrent.ConcurrentSkipListMap.Node<K,V> n = loNode(cmp);
                 isBeforeEnd(n, cmp);
                 n = n.next) {
                if (n.getValidValue() != null)
                    ++count;
    ...
    static {
        try {
            HEAD = U.objectFieldOffset
                (java.util.concurrent.ConcurrentSkipListMap.class.getDeclaredField("head"));
        } catch (ReflectiveOperationException e) {
            throw new Error(e);
        }
    }
