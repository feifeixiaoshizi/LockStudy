    ...
    static {
        try {
            SIZECTL = U.objectFieldOffset
                (java.util.concurrent.ConcurrentHashMap.class.getDeclaredField("sizeCtl"));
            TRANSFERINDEX = U.objectFieldOffset
                (java.util.concurrent.ConcurrentHashMap.class.getDeclaredField("transferIndex"));
            BASECOUNT = U.objectFieldOffset
                (java.util.concurrent.ConcurrentHashMap.class.getDeclaredField("baseCount"));
            CELLSBUSY = U.objectFieldOffset
                (java.util.concurrent.ConcurrentHashMap.class.getDeclaredField("cellsBusy"));
