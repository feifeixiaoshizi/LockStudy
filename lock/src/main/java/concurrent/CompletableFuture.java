...
public class CompletableFuture<T> implements Future<T>, CompletionStage<T> {
    ...
    static AltResult encodeThrowable(Throwable x) {
        return new AltResult((x instanceof java.util.concurrent.CompletionException) ? x :
                             new java.util.concurrent.CompletionException(x));
    }
    ...
    static Object encodeThrowable(Throwable x, Object r) {
        if (!(x instanceof java.util.concurrent.CompletionException))
    ...
    static Object encodeRelay(Object r) {
        ...
        return (((r instanceof AltResult) &&
                 ...
                 !(x instanceof java.util.concurrent.CompletionException)) ?
                new AltResult(new java.util.concurrent.CompletionException(x)) : r);
    }
    ...
    private static <T> T reportJoin(Object r) {
        if (r instanceof AltResult) {
            ...
            if (x instanceof CancellationException)
                throw (CancellationException)x;
            if (x instanceof java.util.concurrent.CompletionException)
                throw (java.util.concurrent.CompletionException)x;
    ...
    final void postComplete() {
         ...
         */
        java.util.concurrent.CompletableFuture<?> f = this; Completion h;
        while ((h = f.stack) != null ||
               (f != this && (h = (f = this).stack) != null)) {
            java.util.concurrent.CompletableFuture<?> d; Completion t;
    ...
    private <V> java.util.concurrent.CompletableFuture<V> uniApplyStage(
        ...
        java.util.concurrent.CompletableFuture<V> d = newIncompleteFuture();
    ...
    private java.util.concurrent.CompletableFuture<Void> uniAcceptStage(Executor e,
                                                                        Consumer<? super T> f) {
        if (f == null) throw new NullPointerException();
        java.util.concurrent.CompletableFuture<Void> d = newIncompleteFuture();
    ...
    final boolean uniRun(java.util.concurrent.CompletableFuture<?> a, Runnable f, UniRun<?> c) {
        Object r; Throwable x;
        if (a == null || (r = a.result) == null || f == null)
            return false;
        if (result == null) {
    ...
    private java.util.concurrent.CompletableFuture<T> uniWhenCompleteStage(
        ...
        if (f == null) throw new NullPointerException();
        java.util.concurrent.CompletableFuture<T> d = newIncompleteFuture();
    ...
    private java.util.concurrent.CompletableFuture<T> uniCopyStage() {
        Object r;
        java.util.concurrent.CompletableFuture<T> d = newIncompleteFuture();
        if ((r = result) != null)
            d.completeRelay(r);
    ...
    static final class CoCompletion extends Completion {
        ...
        final java.util.concurrent.CompletableFuture<?> tryFire(int mode) {
            BiCompletion<?,?,?> c; java.util.concurrent.CompletableFuture<?> d;
    ...
    final void bipush(java.util.concurrent.CompletableFuture<?> b, BiCompletion<?,?,?> c) {
        if (c != null) {
            Object r;
    ...
    final void orpush(java.util.concurrent.CompletableFuture<?> b, BiCompletion<?,?,?> c) {
        if (c != null) {
    ...
    static final class AsyncSupply<T> extends ForkJoinTask<Void>
        implements Runnable, AsynchronousCompletionTask {
        java.util.concurrent.CompletableFuture<T> dep; Supplier<? extends T> fn;
        AsyncSupply(java.util.concurrent.CompletableFuture<T> dep, Supplier<? extends T> fn) {
        ...
        public void run() {
            java.util.concurrent.CompletableFuture<T> d; Supplier<? extends T> f;
    ...
    public <U> java.util.concurrent.CompletableFuture<U> newIncompleteFuture() {
        return new java.util.concurrent.CompletableFuture<U>();
    }
     ...
     */
    // Android-changed: hidden
    public java.util.concurrent.CompletableFuture<T> completeAsync(Supplier<? extends T> supplier,
                                                                   Executor executor) {
     ...
     */
    // Android-changed: hidden
    public java.util.concurrent.CompletableFuture<T> orTimeout(long timeout, TimeUnit unit) {
        if (unit == null)
            throw new NullPointerException();
        if (result == null)
     ...
     */
    // Android-changed: hidden
    public java.util.concurrent.CompletableFuture<T> completeOnTimeout(T value, long timeout,
                                                                       TimeUnit unit) {
        if (unit == null)
            throw new NullPointerException();
        if (result == null)
     ...
     */
    // Android-changed: hidden
    public static <U> java.util.concurrent.CompletableFuture<U> failedFuture(Throwable ex) {
        if (ex == null) throw new NullPointerException();
        return new java.util.concurrent.CompletableFuture<U>(new AltResult(ex));
    }
    ...
    static final class Timeout implements Runnable {
        ...
        Timeout(java.util.concurrent.CompletableFuture<?> f) { this.f = f; }
        public void run() {
            if (f != null && !f.isDone())
    ...
    static final class DelayedCompleter<U> implements Runnable {
        ...
        final U u;
        DelayedCompleter(java.util.concurrent.CompletableFuture<U> f, U u) { this.f = f; this.u = u; }
        public void run() {
            if (f != null)
                f.complete(u);
        }
     ...
     */
    static final class MinimalStage<T> extends java.util.concurrent.CompletableFuture<T> {
        MinimalStage() { }
        MinimalStage(Object r) { super(r); }
        @Override public <U> java.util.concurrent.CompletableFuture<U> newIncompleteFuture() {
        ...
        @Override public int getNumberOfDependents() {
            throw new UnsupportedOperationException(); }
        @Override public java.util.concurrent.CompletableFuture<T> completeAsync
            (Supplier<? extends T> supplier, Executor executor) {
            throw new UnsupportedOperationException(); }
        @Override public java.util.concurrent.CompletableFuture<T> completeAsync
            (Supplier<? extends T> supplier) {
            throw new UnsupportedOperationException(); }
        @Override public java.util.concurrent.CompletableFuture<T> orTimeout
            (long timeout, TimeUnit unit) {
            throw new UnsupportedOperationException(); }
        @Override public java.util.concurrent.CompletableFuture<T> completeOnTimeout
    ...
    static {
        try {
            RESULT = U.objectFieldOffset
                (java.util.concurrent.CompletableFuture.class.getDeclaredField("result"));
            STACK = U.objectFieldOffset
                (java.util.concurrent.CompletableFuture.class.getDeclaredField("stack"));
