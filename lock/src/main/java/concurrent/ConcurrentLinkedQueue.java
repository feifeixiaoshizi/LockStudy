...
public class ConcurrentLinkedQueue<E> extends AbstractQueue<E>
    ...
    static final class CLQSpliterator<E> implements Spliterator<E> {
        ...
        final java.util.concurrent.ConcurrentLinkedQueue<E> queue;
        Node<E> current;    // current node; null until initialized
        int batch;          // batch size for splits
        boolean exhausted;  // true when no more nodes
        CLQSpliterator(java.util.concurrent.ConcurrentLinkedQueue<E> queue) {
            this.queue = queue;
        }

        public Spliterator<E> trySplit() {
            Node<E> p;
            final java.util.concurrent.ConcurrentLinkedQueue<E> q = this.queue;
            int b = batch;
    ...
    static {
        try {
            HEAD = U.objectFieldOffset
                (java.util.concurrent.ConcurrentLinkedQueue.class.getDeclaredField("head"));
            TAIL = U.objectFieldOffset
                (java.util.concurrent.ConcurrentLinkedQueue.class.getDeclaredField("tail"));
