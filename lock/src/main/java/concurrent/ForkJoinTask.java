...
public abstract class ForkJoinTask<V> implements Future<V>, Serializable {
     ...
     */
    static final class ExceptionNode extends WeakReference<java.util.concurrent.ForkJoinTask<?>> {
        final Throwable ex;
        ExceptionNode next;
        final long thrower;  // use id not ref to avoid weak cycles
        final int hashCode;  // store task hashCode before weak ref disappears
        ExceptionNode(java.util.concurrent.ForkJoinTask<?> task, Throwable ex, ExceptionNode next,
     ...
     */
    static final void cancelIgnoringExceptions(java.util.concurrent.ForkJoinTask<?> t) {
    ...
    static void rethrow(Throwable ex) {
        java.util.concurrent.ForkJoinTask.<RuntimeException>uncheckedThrow(ex);
    }
    ...
    public static void invokeAll(java.util.concurrent.ForkJoinTask<?>... tasks) {
        ...
        for (int i = last; i >= 0; --i) {
            java.util.concurrent.ForkJoinTask<?> t = tasks[i];
            if (t == null) {
                if (ex == null)
    ...
    public static <T extends java.util.concurrent.ForkJoinTask<?>> Collection<T> invokeAll(Collection<T> tasks) {
        if (!(tasks instanceof RandomAccess) || !(tasks instanceof List<?>)) {
            invokeAll(tasks.toArray(new java.util.concurrent.ForkJoinTask<?>[tasks.size()]));
            return tasks;
        }
        ...
        int last = ts.size() - 1;
        for (int i = last; i >= 0; --i) {
            java.util.concurrent.ForkJoinTask<?> t = ts.get(i);
            if (t == null) {
                if (ex == null)
                    ex = new NullPointerException();
            }
     ...
     */
    static final class AdaptedRunnable<T> extends java.util.concurrent.ForkJoinTask<T>
     ...
     */
    static final class AdaptedRunnableAction extends java.util.concurrent.ForkJoinTask<Void>
     ...
     */
    static final class RunnableExecuteAction extends java.util.concurrent.ForkJoinTask<Void> {
        final Runnable runnable;
     ...
     */
    static final class AdaptedCallable<T> extends java.util.concurrent.ForkJoinTask<T>
        implements RunnableFuture<T> {
     ...
     * @return the task
     */
    public static java.util.concurrent.ForkJoinTask<?> adapt(Runnable runnable) {
     ...
     * @return the task
     */
    public static <T> java.util.concurrent.ForkJoinTask<T> adapt(Runnable runnable, T result) {
     ...
     * @return the task
     */
    public static <T> java.util.concurrent.ForkJoinTask<T> adapt(Callable<? extends T> callable) {
    ...
    static {
        ...
        try {
            STATUS = U.objectFieldOffset
                (java.util.concurrent.ForkJoinTask.class.getDeclaredField("status"));
