...
public class CopyOnWriteArrayList<E>
    ...
    public CopyOnWriteArrayList(Collection<? extends E> c) {
        ...
        if (c.getClass() == java.util.concurrent.CopyOnWriteArrayList.class)
            elements = ((java.util.concurrent.CopyOnWriteArrayList<?>)c).getArray();
        else {
            elements = c.toArray();
    ...
    public Object clone() {
        try {
            ...
            java.util.concurrent.CopyOnWriteArrayList<E> clone =
                (java.util.concurrent.CopyOnWriteArrayList<E>) super.clone();
            clone.resetLock();
            return clone;
    ...
    public boolean addAll(Collection<? extends E> c) {
        Object[] cs = (c.getClass() == java.util.concurrent.CopyOnWriteArrayList.class) ?
            ((java.util.concurrent.CopyOnWriteArrayList<?>)c).getArray() : c.toArray();
        if (cs.length == 0)
            return false;
        synchronized (lock) {
            Object[] elements = getArray();
    ...
    static {
        try {
            LOCK = U.objectFieldOffset
                (java.util.concurrent.CopyOnWriteArrayList.class.getDeclaredField("lock"));
