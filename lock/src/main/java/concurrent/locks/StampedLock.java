...
public class StampedLock implements java.io.Serializable {
     ...
     * support a {@link java.util.concurrent.locks.Condition}; method {@link
    ...
    static {
        try {
            STATE = U.objectFieldOffset
                (java.util.concurrent.locks.StampedLock.class.getDeclaredField("state"));
            WHEAD = U.objectFieldOffset
                (java.util.concurrent.locks.StampedLock.class.getDeclaredField("whead"));
            WTAIL = U.objectFieldOffset
                (java.util.concurrent.locks.StampedLock.class.getDeclaredField("wtail"));
