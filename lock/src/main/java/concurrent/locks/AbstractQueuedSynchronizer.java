...
public abstract class AbstractQueuedSynchronizer
    ...
    static final class Node {
         ...
         *               on failure, block.
         *               这个节点的后继者是阻塞的，所以在当前这个节点释放或者取消时，要解阻塞它的后继者。
     ...
     * 1.重要的变量，添加了volatile保证内存可见性
     * 2.提供了setState（）和getState（）方法以及compareAndSetState（）方法，其中
     * compareAndSetState（）方法是判断加修改的原子性操作。
     * 3.维持互斥性
     */
    ...
    static void selfInterrupt() {
        //仅仅是改变Thread的中断状态变量，不会中断正在执行的线程，
        // 但是抛出中断的异常的方法在检测到中断状态变化后会抛出异常。
