...
public class LinkedTransferQueue<E> extends AbstractQueue<E>
     ...
     *  {@link BlockingQueue#offer(Object,long, java.util.concurrent.TimeUnit)
     *  BlockingQueue.offer})
     * @throws NullPointerException if the specified element is null
     */
    ...
    static {
        try {
            HEAD = U.objectFieldOffset
                (java.util.concurrent.LinkedTransferQueue.class.getDeclaredField("head"));
            TAIL = U.objectFieldOffset
                (java.util.concurrent.LinkedTransferQueue.class.getDeclaredField("tail"));
            SWEEPVOTES = U.objectFieldOffset
                (java.util.concurrent.LinkedTransferQueue.class.getDeclaredField("sweepVotes"));
        } catch (ReflectiveOperationException e) {
            throw new Error(e);
        }
