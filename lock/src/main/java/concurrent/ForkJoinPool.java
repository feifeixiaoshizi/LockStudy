...
public class ForkJoinPool extends AbstractExecutorService {
    ...
    static final class WorkQueue {
        ...
        final java.util.concurrent.ForkJoinPool pool;   // the containing pool (may be null)
      ...
      // @jdk.internal.vm.annotation.Contended("group2") // segregate // Android-removed
        ...
        WorkQueue(java.util.concurrent.ForkJoinPool pool, ForkJoinWorkerThread owner) {
            this.pool = pool;
            this.owner = owner;
         ...
         */
        final void transferStealCount(java.util.concurrent.ForkJoinPool p) {
            AuxState aux;
    ...
    static int getSurplusQueuedTaskCount() {
        Thread t; ForkJoinWorkerThread wt; java.util.concurrent.ForkJoinPool pool; WorkQueue q;
    ...
    static WorkQueue commonSubmitterQueue() {
        java.util.concurrent.ForkJoinPool p = common;
    ...
    static {
        try {
            CTL = U.objectFieldOffset
                (java.util.concurrent.ForkJoinPool.class.getDeclaredField("ctl"));
            RUNSTATE = U.objectFieldOffset
                (java.util.concurrent.ForkJoinPool.class.getDeclaredField("runState"));
            ABASE = U.arrayBaseOffset(ForkJoinTask[].class);
            int scale = U.arrayIndexScale(ForkJoinTask[].class);
            if ((scale & (scale - 1)) != 0)
                throw new Error("array index scale not a power of two");
        ...
        common = java.security.AccessController.doPrivileged
            (new java.security.PrivilegedAction<java.util.concurrent.ForkJoinPool>() {
                public java.util.concurrent.ForkJoinPool run() { return makeCommonPool(); }});
    ...
    static java.util.concurrent.ForkJoinPool makeCommonPool() {
        ...
        if (parallelism > MAX_CAP)
            parallelism = MAX_CAP;
        return new java.util.concurrent.ForkJoinPool(parallelism, factory, handler, LIFO_QUEUE,
