...
public enum TimeUnit {
    ...
    NANOSECONDS {
        ...
        public long convert(long d, java.util.concurrent.TimeUnit u) { return u.toNanos(d); }
    ...
    MICROSECONDS {
        ...
        public long convert(long d, java.util.concurrent.TimeUnit u) { return u.toMicros(d); }
    ...
    MILLISECONDS {
        ...
        public long convert(long d, java.util.concurrent.TimeUnit u) { return u.toMillis(d); }
    ...
    SECONDS {
        ...
        public long convert(long d, java.util.concurrent.TimeUnit u) { return u.toSeconds(d); }
        int excessNanos(long d, long m) { return 0; }
    },
    ...
    MINUTES {
        ...
        public long convert(long d, java.util.concurrent.TimeUnit u) { return u.toMinutes(d); }
        int excessNanos(long d, long m) { return 0; }
    },
    ...
    DAYS {
        ...
        public long convert(long d, java.util.concurrent.TimeUnit u) { return u.toDays(d); }
        int excessNanos(long d, long m) { return 0; }
    };
