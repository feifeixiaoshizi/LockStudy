...
public class ConcurrentSkipListSet<E>
    ...
    public java.util.concurrent.ConcurrentSkipListSet<E> clone() {
        try {
            ...
            java.util.concurrent.ConcurrentSkipListSet<E> clone =
                (java.util.concurrent.ConcurrentSkipListSet<E>) super.clone();
    ...
    public NavigableSet<E> headSet(E toElement, boolean inclusive) {
        return new java.util.concurrent.ConcurrentSkipListSet<E>(m.headMap(toElement, inclusive));
    }
    ...
    public NavigableSet<E> tailSet(E fromElement, boolean inclusive) {
        return new java.util.concurrent.ConcurrentSkipListSet<E>(m.tailMap(fromElement, inclusive));
    }
    ...
    public NavigableSet<E> descendingSet() {
        return new java.util.concurrent.ConcurrentSkipListSet<E>(m.descendingMap());
    }
    ...
    static {
        try {
            MAP = U.objectFieldOffset
                (java.util.concurrent.ConcurrentSkipListSet.class.getDeclaredField("m"));
