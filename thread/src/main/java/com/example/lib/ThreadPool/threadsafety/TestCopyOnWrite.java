package com.example.lib.ThreadPool.threadsafety;
...
public class TestCopyOnWrite {
    ...
    static List synchronizedList =new CopyOnWriteArrayList();
    ...
    * */
    ...
    static class ReadRunnable implements Runnable {
        ...
        public void run() {
            ...
            Exception in thread "Thread-2" Exception in thread "Thread-3"
             Exception in thread "Thread-4" java.lang.ArrayIndexOutOfBoundsException: 9
	...
	at com.example.ThreadPool.threadsafety.TestCopyOnWrite$ReadRunnable.run(TestCopyOnWrite.java:179)
	at java.lang.Thread.run(Thread.java:745)
*/
                ...
                for (int i = 0; i < synchronizedList.size(); i++) {
                    ...
                    //即使使用了CopyOnWriteArrayList，但是for循环这个过程还是不能保证原子性操作，依然可能报数组越界问题。（******）
                    System.out.println("read:" + synchronizedList.get(i));
                }
    ...
    static class ReadIteratorRunnable implements Runnable {
        ...
        public void run() {
            ...
            for(Object integer : synchronizedList){
                ...
                //线程安全
                System.out.println("read:" + integer+"size:"+synchronizedList.size());
            }
    ...
    static class RemoveIteratorRunnalbe implements Runnable {
        ...
        public void run() {
            try {
                ...
                synchronizedList.clear();
                //线程安全
                System.out.println("remove:"+"size:"+synchronizedList.size());
